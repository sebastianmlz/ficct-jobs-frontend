...
export class DashboardComponent implements OnInit {
  ...
  protected readonly candidateActions = [
    ...
    { label: 'Mis postulaciones', path: '/applications', icon: 'clipboard-check', iconBg: 'bg-emerald-50', iconColor: 'text-emerald-600' },
    { label: 'Mi perfil', path: '/profile', icon: 'user', iconBg: 'bg-amber-50', iconColor: 'text-amber-600' },
    { label: 'Asistente', path: '/chat', icon: 'chat', iconBg: 'bg-purple-50', iconColor: 'text-purple-600' },
  ];

  protected readonly repActions = [
    { label: 'Nueva vacante', path: '/rep/vacancies/new', icon: 'plus', iconBg: 'bg-ficct-50', iconColor: 'text-ficct-600' },
    { label: 'Mis vacantes', path: '/rep/vacancies', icon: 'briefcase', iconBg: 'bg-emerald-50', iconColor: 'text-emerald-600' },
    { label: 'Asistente', path: '/chat', icon: 'chat', iconBg: 'bg-purple-50', iconColor: 'text-purple-600' },
  ];

  protected readonly adminActions = [
    { label: 'Resumen', description: 'Métricas en tiempo real del canal', path: '/admin/overview', icon: 'chart-bar', iconBg: 'bg-ficct-50', iconColor: 'text-ficct-600' },
    { label: 'Candidatos', description: 'Validar y gestionar cuentas', path: '/admin/candidates', icon: 'users', iconBg: 'bg-emerald-50', iconColor: 'text-emerald-600' },
    { label: 'Cola de vacantes', description: 'Aprobar publicaciones pendientes', path: '/admin/vacancies', icon: 'clipboard-list', iconBg: 'bg-amber-50', iconColor: 'text-amber-600' },
    { label: 'Empresas', description: 'Registrar y gestionar aliados', path: '/admin/companies', icon: 'building', iconBg: 'bg-purple-50', iconColor: 'text-purple-600' },
    { label: 'Auditoría', description: 'Bitácora inmutable de operaciones', path: '/admin/audit', icon: 'document', iconBg: 'bg-slate-100', iconColor: 'text-slate-600' },
    { label: 'Parámetros', description: 'Configuración del sistema', path: '/admin/parameters', icon: 'cog', iconBg: 'bg-rose-50', iconColor: 'text-rose-600' },
  ];
