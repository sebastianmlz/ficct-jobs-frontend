...
export class JobsService {
  ...
  transitionVacancy(
    ...
    return this.api.post<Vacancy>(`/jobs/vacancies/${id}/transition/`, {
      action,
    });
  }
  ...
  approveVacancy(
    ...
    return this.api.post<Vacancy>(`/jobs/vacancies/${id}/approval/`, {
      action,
      reason,
    });
  }
  ...
  apply(vacancyId: string, coverLetter = ""): Observable<ApplicationItem> {
    return this.api.post<ApplicationItem>(
      `/jobs/vacancies/${vacancyId}/apply/`,
      {
  ...
  vacancyApplications(vacancyId: string): Observable<ApplicationItem[]> {
    return this.api.get<ApplicationItem[]>(
      `/jobs/vacancies/${vacancyId}/applications/`,
    );
  }
  ...
  transitionApplication(
    ...
    return this.api.post<ApplicationItem>(
      `/jobs/applications/${id}/transition/`,
      { stage },
    );
  }
  ...
  notifyApplication(
    ...
    return this.api.post<ApplicationItem>(
      `/jobs/applications/${id}/notify/`,
      payload,
    );
  }

  listAttachments(vacancyId: string): Observable<VacancyAttachment[]> {
    return this.api.get<VacancyAttachment[]>(
